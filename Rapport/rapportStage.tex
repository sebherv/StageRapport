...
\para Cette introduction présente les activités de Tellus Environment et introduit le contexte du projet Symeter V2.
	...
	\para Tellus Environment peut aussi coordonner la mise en oeuvre d'équipements d'acquisition marins - sonar, multibeam, \underline{percuteur} \todoCheck{est-ce le bon terme?} - pour permettre la cartographie des fonds marins et des sous-sols aquatiques, que ce soit en environnement eau douce - rivières, lacs étangs - ou marins. 
...
\chapter{Capteurs, Modélisation, Contraintes}
	...
	\section{Capteurs}
		...
		\missingfigure{Architecture capteurs --> flux de données.}
...
\section{Contraintes de mise en oeuvre}
	...
	\section{Mise en Oeuvre: simulation d'un environnement de tassage de silo}
		...
		\subsubsection{Propulsion et Guidage}
			...
			\todoCompleter{Calcul des vitesses de rotation}
